...
export const stats = [
  ...
  { value: "19", label: "Power substations (up to 132 KV)" },
  { value: "2.07B", label: "Total project value" },
];

export const mascoStats = [
  { value: "40+", label: "Years of experience" },
  { value: "1300+", label: "KM roads" },
  { value: "400M+", label: "m³ treated water / year" },
  { value: "1M+", label: "m² building surface" },
  { value: "36M+", label: "m² infrastructure surface works" },
  { value: "447+", label: "Km railways high-speed train" },
  { value: "40+", label: "Bridges" },
  { value: "20+", label: "m³ of rocks ballasted" },
];
